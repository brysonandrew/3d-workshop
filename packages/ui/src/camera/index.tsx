...
import { LayoutCameraProps } from "framer-motion-3d/types/components/types";
import {
  CanvasTexture,
  MeshBasicMaterial,
  PlaneGeometry,
...
export function Scene({ isFullscreen }: any) {
  return (
...
function Lights({ isFullscreen }: any) {
